(function ()
{
  ...
  1    : [
    ...
    }, {"locutus/php/strings/htmlspecialchars": 29}
  ], 39: [
    function (require, module, exports)
    {
    ...
    }, {"es5-util/js/isNotSetLoose": 8, "es5-util/js/toUnixTime": 22, "locutus/php/datetime/strftime": 26}
  ], 42: [
    function (require, module, exports)
    {
    ...
    }, {"es5-util/js/isObjectLike": 11, "es5-util/js/toAssociativeValues": 17}
  ], 46: [
    function (require, module, exports)
    {
    ...
    }, {"es5-util/js/toNumber": 19, "locutus/php/strings/number_format": 30}
  ], 47: [
    function (require, module, exports)
    {
    ...
    }, {"locutus/php/strings/str_pad": 32}
  ], 48: [
    function (require, module, exports)
    {
      var str_pad = require('locutus/php/strings/str_pad');
    ...
    }, {"locutus/php/strings/str_repeat": 33}
  ], 51: [
    function (require, module, exports)
    {
    ...
    {
      "es5-util/js/isArrayLikeObject"  : 4,
      "es5-util/js/toArray"            : 16,
      "locutus/php/array/array_reverse": 25,
      "locutus/php/strings/strrev"     : 35
    }
  ], 53: [
    function (require, module, exports)
    {
    ...
    }, {"locutus/php/strings/strip_tags": 34}
  ], 54: [
    function (require, module, exports)
    {
    ...
    }, {"./getNestedParts": 60, "./replaceParts": 65, "es5-util/js/toArray": 16, "es5-util/js/toString": 20}
  ], 57: [
    function (require, module, exports)
    {
      var getNestedParts = require('./getNestedParts');
    ...
    }, {"./getNestedParts": 60, "./replaceDelims": 64, "./replaceParts": 65}
  ], 58: [
    function (require, module, exports)
    {
    ...
    }, {"./encodeTemplate": 57, "./replaceParts": 65, "locutus/php/strings/explode": 28}
  ], 59: [
    function (require, module, exports)
    {
    ...
    }, {"./encodeTemplate": 57, "./replaceParts": 65, "es5-util/js/toArray": 16, "es5-util/js/toString": 20}
  ], 62: [
    function (require, module, exports)
    {
      var isArrayLikeObject = require('es5-util/js/isArrayLikeObject');
    ...
    }, {"es5-util/js/isArrayLikeObject": 4, "es5-util/js/isObject": 10}
  ], 63: [
    function (require, module, exports)
    {
    ...
    {
      "es5-util/js/isEmptyLoose"   : 5,
      "es5-util/js/isNotEmptyLoose": 7,
      "es5-util/js/isNotSetTag"    : 9,
      "es5-util/js/isSetTag"       : 13
    }
  ], 76: [
    function (require, module, exports)
    {
